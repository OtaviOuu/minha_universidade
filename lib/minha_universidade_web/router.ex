defmodule MinhaUniversidadeWeb.Router do
  use MinhaUniversidadeWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {MinhaUniversidadeWeb.Layouts, :root}
  ...
  scope "/", MinhaUniversidadeWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {MinhaUniversidadeWeb.LiveUserAuth, :live_no_user}
    end
  end
  ...
  scope "/", MinhaUniversidadeWeb do
    ...
    sign_in_route register_path: "/register",
                  ...
                  on_mount: [{MinhaUniversidadeWeb.LiveUserAuth, :live_no_user}],
                  overrides: [
                    MinhaUniversidadeWeb.AuthOverrides,
    ...
    confirm_route MinhaUniversidade.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [
        MinhaUniversidadeWeb.AuthOverrides,
        Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI
    ...
    magic_sign_in_route(MinhaUniversidade.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [
        MinhaUniversidadeWeb.AuthOverrides,
        Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI
  ...
  # scope "/api", MinhaUniversidadeWeb do
  #   pipe_through :api
  # end
