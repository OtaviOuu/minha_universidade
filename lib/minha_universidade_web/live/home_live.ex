defmodule MinhaUniversidadeWeb.HomeLive do
  use MinhaUniversidadeWeb, :live_view

  def render(assigns) do
    ~H"""
    <Layouts.landing_app {assigns}>
      <header>
        <!-- Container -->
        <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
          <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="mb-6 text-sm text-gray-500 sm:text-xl lg:mb-8">
            ...
            <!-- Button -->
            <div class="button-bg inline-block rounded-full p-[2px] hover:scale-105 transition duration-300 active:scale-100 mr-6 lg:mr-8">
              <.link
                navigate={~p"/universidades"}
                class="block px-8 py-4 text-sm font-semibold text-white rounded-full bg-gray-900 text-center"
              >
                Ver Universidades
              </.link>
            </div>
          ...
          <!-- List -->
          <ul class="mt-16 grid gap-8 sm:mt-24 sm:grid-cols-3 sm:gap-12 md:grid-cols-5 md:gap-4">
